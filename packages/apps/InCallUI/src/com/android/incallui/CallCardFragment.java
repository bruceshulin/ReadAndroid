...
public class CallCardFragment extends BaseFragment<CallCardPresenter, CallCardPresenter.CallCardUi>
    ...
    private TextView mGeocodeView;  // SPRD: Geocode View
    ...
    public void onViewCreated(View view, Bundle savedInstanceState) {
        ...
        mFloatingActionButton.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
				...
				intent.setAction("android.provider.Telephony.END_CALL");  
				mcontext.sendBroadcast(intent);
				Log.v("BRUCESEND", "sendBroadcast ENDCALL ");				
            }
        });
            ...
            public boolean onPreDraw() {
                ...
                if(mIsLandscape){
                    ...
                    if(visible){
                        ...
                        params.height = mPrimaryCallCardContainer.getHeight();
                        params.width = params.height*11/9;
                    }
    ...
    public void setPrimary(String number, String name, boolean nameIsNumber, String label,
        ...
        /* SPRD: add for Geocode @{ */
        if (mGeocodeView != null) {
            if(!TextUtils.isEmpty(number)){
                GeocodeHelper.getGeocodeMessage(mGeocodeView, number);
            }else{
                GeocodeHelper.getGeocodeMessage(mGeocodeView, name);
            }
        }
        /* @} */
        // set the name field.
    ...
    public void setCallState(
            int subId,  // SPRD: modify for bug 430163
            int state,
            int videoState,
        ...
        CharSequence callStateLabel = getCallStateLabelFromState(subId, state, videoState,
        ...
        // SPRD: fix bug 427972
        if (CallUtil.isVideoEnabled(getView().getContext()) && (VideoProfile.VideoState.isBidirectional(videoState)
     ...
     * @param subId
     */
    private CharSequence getCallStateLabelFromState(int subId, int state, int videoState,
        ...
        // SPRD: modify for bug437911
        TelephonyManagerSprd telephonyManagerSprd = (TelephonyManagerSprd) TelephonyManager.from(context);
        ...
        switch  (state) {
            ...
            case Call.State.ACTIVE:
                ...
                if (isAccount) {
                    /* SPRD: modify for bug 430163 {@ */
                    int PrimaryCardId = telephonyManagerSprd.getPrimaryCard();
                    int phoneId = SubscriptionManager.getPhoneId(subId);
                    String card_slot = "";
                    if(phoneId == PrimaryCardId){
                        card_slot = this.getString(R.string.main_card_slot);
                    }else{
                        card_slot = this.getString(R.string.gsm_card_slot);
                    }
                    callStateLabel = card_slot + label;
                    /* @} */
            ...
            case Call.State.DIALING:
                if (isSpecialCall) {
                    ...
                    callStateLabel = card_slot+context.getString(R.string.calling_via_template, label);
    ...
    private Animator getShrinkAnimator(int startHeight, int endHeight) {
        ...
        shrinkAnimator.addListener(new AnimatorListenerAdapter() {
            ...
            public void onAnimationStart(Animator animation) {
                ...
                assignTranslateAnimation(mGeocodeView, 2); // SPRD: Geocode
    ...
    private void setViewStatePostAnimation(OnLayoutChangeListener layoutChangeListener) {
        ...
        setViewStatePostAnimation(mGeocodeView); // SPRD: Geocode
...
//------------------- SPRD ------------------------
     ...
     * Add getSpaceBesideCallCard2() to get the hight of primary_call_info_container for Bug383094
     */
    public float getSpaceBesideCallCard2() {
        View view = getView();
        if (view == null) {
            return 0;
        }
        int cardHeight = 0;
        if (mCallButtonsContainer != null && mPrimaryCallInfo != null) {
            cardHeight = view.getHeight() - mCallButtonsContainer.getHeight()
                    - mPrimaryCallInfo.getHeight();
        }
        if (mInCallMessageLabel != null) {
            cardHeight -= mInCallMessageLabel.getHeight();
        }
        return cardHeight;
    }
    /** @} */
