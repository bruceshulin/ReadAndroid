...
public final class Call {
    ...
    // SPRD: fix bug 432259
    private boolean mIsVideoToAudio;
    ...
    /* SPRD: fix bug 432259 @{ */
    public boolean getIsVideoStateChange() {
        return mIsVideoToAudio;
     }

    public void setVideoStateChange(boolean change) {
        mIsVideoToAudio = change;
    }
    /* @} */
    ...
    public boolean isGroupCall(){
        return can(android.telecom.Call.Details.CAPABILITY_GROUP_CALL);
    }

    public boolean isVolteCall(){
        return can(android.telecom.Call.Details.CAPABILITY_VOLTE);
    }
    /*@}*/
