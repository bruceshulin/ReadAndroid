...
public class VideoCallPresenter extends Presenter<VideoCallPresenter.VideoCallUi>  implements
    ...
    public void onSurfaceCreated(int surface) {
        ...
        Log.i(this, "onSurfaceCreated->surface:" + surface + " ui is null?:"
                + (ui == null) + "  videoCall is null?:" + (mVideoCall == null));
    ...
    public void onStateChange(InCallPresenter.InCallState oldState,
        ...
        if(primary != null && getUi() != null){
            ...
            shouldUpdateUi = getUi().isVideoSurfacesInUse() && !primary.isVideoCall(mContext);
            if(TelephonyManagerSprd.getVolteEnabled()
                    && (primary.isVideoCall(mContext) != getUi().isVideoSurfacesInUse())){
                shouldUpdateUi = true;
                Log.i(this, "onStateChange->primaryChanged:" + primaryChanged
                        + " shouldUpdateUi:"+ (shouldUpdateUi) + "  isVideoSurfacesInUse:" + getUi().isVideoSurfacesInUse());
            }
        }
    ...
    private void enterVideoMode() {
        ...
        // SPRD: add for bug427890
        if (DBG) Log.i(this, "enterVideoMode ui is null?:" + (ui == null) + " mVideoCall is null?:" + (mVideoCall == null));
        if (ui == null) {
            return;
        }
        ...
        /** @} */
           //SPRD:change setInCallAllowsOrientationChange true to false for428252
        ...
        if(mPreVideoAudioMode == AudioState.ROUTE_EARPIECE
    ...
    private void exitVideoMode() {
        VideoCallUi ui = getUi();
        // SPRD: add for bug427890
        if (DBG) Log.i(this, "exitVideoMode ui is null?:" + (ui == null) + " mVideoCall is null?:" + (mVideoCall == null));
        if (ui == null) {
            return;
        }
        // SPRD: modify for surface don't clear while call hang up @{
        if (mVideoCall != null) {
            mVideoCall.setDisplaySurface(null);
            mVideoCall.setPreviewSurface(null);
        }
