...
public class AnswerFragment extends BaseFragment<AnswerPresenter, AnswerPresenter.AnswerUi>
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        //SPRD Performance
        mGlowpad = (GlowPadWrapper)PreloadUtils.getInstance().getAnswerView();
        if (mGlowpad == null) {
    ...
    /* SPRD: fix bug bug448859 @{ */
    @Override
    public void onResume() {
        super.onResume();
        InCallPresenter.getInstance().setShowAnswerUi(true);
    }

    @Override
    public void onPause() {
        super.onPause();
        InCallPresenter.getInstance().setShowAnswerUi(false);
    }
    /* @} */
    /**
    ...
    public void showTargets(int targetSet) {
        ...
        // SPRD: fix bug 432115
        getPresenter().setIsRejectCallBySms(false);
    ...
    /** SPRD: Modify for bug424700 @{ */
    public void showSMSRejectionActivity() {
        getPresenter().onDecline();
        // SPRD: fix bug 432115
        getPresenter().setIsRejectCallBySms(true);

        getActivity().getWindow().addFlags(WindowManager.LayoutParams.FLAG_DISMISS_KEYGUARD);
        Intent mmsIntent = new Intent(Intent.ACTION_SENDTO, Uri.fromParts("smsto", getPresenter().getCall().getNumber(), null));
