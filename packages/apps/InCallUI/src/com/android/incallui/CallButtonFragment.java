...
public class CallButtonFragment
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        //SPRD Performance
        View parent = PreloadUtils.getInstance().getCallButtonView();
        if (parent == null) {
        ...
        /* SPRD: move onClickListener to onClick(View view) method for bug427896 @{ */
    ...
    public void onClick(View view) {
        int id = view.getId();
        android.util.Log.d("suzie", "onClick(View " + view + ", id " + id + ")...");
        ...
        switch(id) {
            ...
            case R.id.switchCameraButton:
                ...
                /* SPRD:add a judgment on whether mPauseVideoButton is selected for bug427447 @ { */
                if(mPauseVideoButton!= null && mPauseVideoButton.isSelected()){
                    //SPRD:change mPauseVideoButton.setSelected to getPresenter().pauseVideoClicked for bug427447
                    //mPauseVideoButton.setSelected(!mPauseVideoButton.isSelected());
    ...
    public void updateColors() {
        ...
        View[] compoundButtons = {
                ...
                mInviteButton // SPRD: Add for VoLTE
        };
    ...
    /*
    * SPRD:add enableSwitchCameraButton() for Bug427447
    * @{
    */
    @Override
    public void enableSwitchCameraButton(boolean enabled) {
        mSwitchCameraButton.setEnabled(enabled);
        if(enabled){
    ...
    */
    /*
    * SPRD:add enablePauseVideoButton() for Bug427447
    * @{
    */
    @Override
    public void enablePauseVideoButton(boolean enabled) {
        mPauseVideoButton.setEnabled(enabled);
    }
    /*
    * @}
    */
    ...
    public void showPauseVideoButton(boolean show) {
        ...
        if(show &&
        InCallPresenter.getInstance().getInCallCameraManager().isCameraPaused()){
    ...
    /* sprd: add for to display many buttons { */
    @Override
    public void showInviteButton(boolean show) {
        mInviteButton.setVisibility(show ? View.VISIBLE : View.GONE);
    }
    /* } */
    ...
    public void configureOverflowMenu(boolean showMergeMenuOption, boolean showAddMenuOption,
                ...
                public boolean onMenuItemClick(MenuItem item) {
                    switch (item.getItemId()) {
                        ...
                        case R.id.overflow_swap_menu_item:
                            ...
                            break;
                        /* sprd: add for to display many buttons { */
                        case R.id.overflow_changetovideo_menu_item:
                            getPresenter().changeToVideoClicked();
                            break;
                        case R.id.overflow_invite_menu_item:
                            getPresenter().inviteClicked();
                            break;
                        case R.id.overflow_changetoaudio_menu_item:
                            getPresenter().changeToVoiceClicked();
                            break;
                        case R.id.overflow_switchcamera_menu_item:
                            getPresenter().switchCameraClicked(mSwitchCameraButton.isSelected());
                            break;
                        /* } */
                        default:
        ...
        /* sprd: add for to display many buttons { */
        menu.findItem(R.id.overflow_changetovideo_menu_item).setVisible(showChangeToVideoOption);
        menu.findItem(R.id.overflow_invite_menu_item).setVisible(showInviteMenuOption);
        menu.findItem(R.id.overflow_changetoaudio_menu_item).setVisible(showChangeToVoiceOption);
        menu.findItem(R.id.overflow_switchcamera_menu_item).setVisible(showSwitchCameraOption);
        /* } */
...
// ---------------------- SPRD ---------------------
    ...
    public void toggleRecord() {
        android.util.Log.d("suzie", "toggleRecord............. ");
        if (getActivity() != null && getActivity() instanceof InCallActivity) {
            android.util.Log.d("suzie", "toggleRecord............22222. ");
    ...
    @Override
    public void enableAddCall(boolean on) {
        mAddCallButton.setEnabled(on);
    }
}
